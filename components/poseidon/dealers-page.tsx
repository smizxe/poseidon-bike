  ...
  return (
    <div className="pb-20 pt-28 md:pt-32">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="space-y-5">
              ...
              <h1 className="font-heading text-4xl leading-tight font-semibold tracking-tight md:text-6xl">
                Một trang dành riêng cho mạng lưới phân phối, showroom và điểm bán.
              </h1>
              <p className="max-w-2xl text-base leading-8 text-muted-foreground md:text-lg">
                Trang này gom được cả danh sách đại lý, phân vùng địa lý và lời mời
                hợp tác để sau này dùng cho cả người mua lẫn đối tác phân phối.
              </p>
      ...
      <section className="section-shell py-20">
        <SectionHeading
          eyebrow="Lợi ích hợp tác"
          title="Trang đại lý không chỉ để liệt kê địa điểm, mà còn để thuyết phục đối tác"
          description="Mình để sẵn các card nêu rõ quyền lợi hợp tác để sau này bổ sung form đăng ký hoặc hồ sơ tải về sẽ rất hợp lý."
          align="center"
        />
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
            <div className="space-y-4">
              ...
              <h2 className="font-heading text-3xl font-semibold tracking-tight md:text-5xl">
                Có thể mở rộng thành landing tuyển đại lý chỉ bằng cách thêm form.
              </h2>
              <p className="max-w-2xl text-base leading-8 text-slate-300 md:text-lg">
                Hiện tại mình để đây như một CTA mẫu. Sau này chỉ cần nối form,
                Zalo OA, hotline hoặc CRM là đủ thành một workflow hoàn chỉnh.
              </p>
            </div>
            ...
            <div className="rounded-[1.8rem] border border-white/10 bg-white/6 p-6">
              ...
              <div className="space-y-4 text-sm leading-7 text-slate-300">
                <p>1. Form đăng ký đại lý với khu vực, diện tích và năng lực bán.</p>
                <p>2. Bộ tài liệu tải xuống gồm price list, chính sách và POSM.</p>
                <p>3. Lịch hẹn tư vấn trực tiếp hoặc gọi hotline vùng miền.</p>
              </div>
              <div className="mt-6">
                <Link
                  href="/san-pham"
