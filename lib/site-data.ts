...
export const products = [
  {
    ...
    specs: ["Nhôm 6061", "Shimano 2x8", "Phanh dầu MT200", "700x32c"],
    badge: "Commuter",
    weight: "14 kg",
    wheelSize: "700x32c (~28 inch)",
    frame: "Nhôm 6061 + càng Magie đúc nguyên khối",
    groupset: "Shimano M315 / Altus M310 2x8",
    ...
    highlights: [
      ...
      "Moay-ơ ARC 6 bạc đạn cối nổ",
      "Bàn đạp nhôm 3 bạc đạn bản mới",
    ],
  },
  {
    slug: "poseidon-ps101",
  ...
  },
  {
    ...
    category: "road",
    categoryLabel: "Road",
    image: "/products/ps650.jpg",
    gallery: ["/products/ps650.jpg", "/products/ps650-2.jpg", "/products/ps650-3.jpg"],
    tagline: "Road entry-performance với khung Magie đúc nguyên khối, Sensah Reflex 2x8 và vóc dáng tốc độ dễ tiếp cận.",
    specs: ["Khung Magie", "Sensah Reflex 2x8", "700x28c", "14,2 kg"],
    badge: "Road Entry",
    weight: "14,2 kg",
    wheelSize: "700x28c (~28 inch)",
    frame: "Khung Magie đúc nguyên khối",
    groupset: "Sensah Reflex 2x8",
    brake: "Phanh đĩa cơ road",
    highlights: [
      ...
      "Ghi-đông và cọc yên nhôm bản dẹt",
    ],
  },
  {
    slug: "poseidon-ps700",
