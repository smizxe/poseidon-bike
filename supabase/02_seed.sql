...
values
  (
    ...
    'Poseidon PS250',
    'Poseidon PS250 là mẫu xe Touring thực thụ, cân bằng giữa độ bền bỉ, tư thế lái thoải mái cho những hành trình xuyên Việt và khám phá.',
    '/products/ps250.jpg',
  ...
  (
    ...
    'Poseidon PS600',
    'Mẫu Touring hiện đại với khung-càng Magie đúc nguyên khối, tối ưu trọng lượng cho những chuyến đi xa mà không mệt mỏi.',
    '/products/ps600.jpg',
